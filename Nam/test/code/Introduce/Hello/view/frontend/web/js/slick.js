...
jQuery(function() {
    ...
    Slick.prototype.buildDots = function() {
        ...
        if (_.options.dots === true) {
            ...
            for (i = 0; i <= _.getDotCount(); i += 1) {
                ...
                dot.append(jQuery('<li />').append('<i class="fa fa-circle" aria-hidden="true"></i>'));
            }
    ...
    Slick.prototype.cleanUpSlideEvents = function() {
        ...
        _.$list.off('mouseenter.slick', jQuery.proxy(_.interrupt, _, true));
        _.$list.off('mouseleave.slick', jQuery.proxy(_.interrupt, _, false));
    ...
    Slick.prototype.initSlideEvents = function() {
        ...
        if ( _.options.pauseOnHover ) {
            ...
            _.$list.on('mouseenter.slick', jQuery.proxy(_.interrupt, _, true));
            _.$list.on('mouseleave.slick', jQuery.proxy(_.interrupt, _, false));
