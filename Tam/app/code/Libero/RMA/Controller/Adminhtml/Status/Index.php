<?php
namespace Libero\RMA\Controller\Adminhtml\Status;
...
class Index extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu("Libero_RMA::rma_status");
    ...
    protected function _isAllowed()
    {
        ...
        return $this->_authorization->isAllowed('Libero_RMA::rma_status');
    }
}